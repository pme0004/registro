...
public class Registro extends JFrame {
	...
	public Registro() {
		...
		campomail.setBounds(309, 67, 101, 20);
		...
		labelrepetir.setBounds(174, 129, 156, 14);
		...
		btnregistro.setBounds(301, 273, 122, 23);
		contentPane.add(btnregistro);
		
		campocontraseña = new JPasswordField();
		campocontraseña.setBounds(309, 98, 101, 20);
		contentPane.add(campocontraseña);
		
		campocontraseña2 = new JPasswordField();
		campocontraseña2.setBounds(309, 129, 101, 20);
		...
		checkpolitica.setBounds(265, 234, 206, 23);
		...
		lblNewLabel_6.setBounds(174, 154, 498, 27);
		contentPane.add(lblNewLabel_6);
		
		JLabel lblNewLabel_7 = new JLabel("ocho caracteres y el mail una arroba y un punto");
		lblNewLabel_7.setBounds(174, 179, 367, 14);
		contentPane.add(lblNewLabel_7);
		
		checkcontraseña.setBounds(416, 97, 138, 23);
